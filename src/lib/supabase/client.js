  ...
  if (!_client) {
    ...
    _client = createBrowserClient(url, key, {
      auth: {
        ...
        persistSession: true,
        // Bypass the Navigator LockManager entirely — just run auth operations
        // immediately without serialization. A rare double token refresh is
        // harmless; cascading lock timeouts break the entire app.
