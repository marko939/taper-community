...
import AuthenticatedHomeOverlay from '@/components/home/AuthenticatedHomeOverlay';
...
export default function HomePage() {
  return (
    <>
      <AuthenticatedHomeOverlay />

      <div id="landing-content" className="space-y-8 sm:space-y-12">
        <section
  ...
  return (
    <div className="-mx-4 overflow-x-auto px-4 sm:mx-0 sm:px-0">
      <table className="w-full min-w-[520px] text-xs sm:min-w-0 sm:text-sm" style={{ borderCollapse: 'separate', borderSpacing: 0 }}>
        ...
        <tbody>
          {rows.map(([feature, tc, bb, sa, reddit], i) => (
            <tr key={i}>
