...
export default function ForumSections() {
  ...
  // Drug forums — show top 6 by post count
  const drugForums = forums
    .filter((f) => f.category === 'drug')
  ...
  const sections = [
    ...
    { key: 'research', label: 'Research & News', forums: forums.filter((f) => f.category === 'research') },
    { key: 'drug', label: 'Drug-Specific Forums', forums: drugForums },
  ];
